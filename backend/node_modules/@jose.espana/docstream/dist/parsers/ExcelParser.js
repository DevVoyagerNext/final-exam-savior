...
const parseExcel = async (buffer, config) => {
    ...
    for (const file of files) {
        ...
        if (file.path.match(sheetsRegex)) {
            ...
            const sheetXml = (0, xmlUtils_1.parseXmlString)(sheetXmlStr);
            const hyperlinkNodes = (0, xmlUtils_1.getElementsByTagName)(sheetXml, "hyperlink");
            if (hyperlinkNodes.length > 0) {
                ...
                const sheetRels = {};
                if (relsFileHL) {
                    const relsXml = (0, xmlUtils_1.parseXmlString)(relsFileHL.content.toString());
                    const rels = (0, xmlUtils_1.getElementsByTagName)(relsXml, "Relationship");
