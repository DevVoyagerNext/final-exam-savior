...
exports.detectOLE2Format = exports.isOLE2 = exports.parseOLE2 = void 0;
// ============================================================================
// Constants
// ============================================================================
...
function parseOLE2(data) {
    ...
    for (let i = 0; i < HEADER_DIFAT_ENTRIES && fatSectorIndices.length < numFatSectors; i++) {
        ...
        if (idx === FREESECT || idx === ENDOFCHAIN)
            break;
    ...
    // ------------------------------------------------------------------
    function readChain(startSector, streamSize) {
    ...
    // ------------------------------------------------------------------
    function readMiniChain(startSector, streamSize) {
        if (startSector === ENDOFCHAIN || streamSize === 0) {
            return Buffer.alloc(0);
        }
    ...
    function findEntry(name) {
        ...
        return entries.find(e => e.entryType !== STGTY_EMPTY &&
            e.name.toLowerCase() === lowerName);
    }
    /** Read a stream by its directory entry */
    function readStreamEntry(entry) {
        if (entry.size === 0) {
            return Buffer.alloc(0);
        }
 ...
 */
function detectOLE2Format(container) {
...
exports.detectOLE2Format = detectOLE2Format;
