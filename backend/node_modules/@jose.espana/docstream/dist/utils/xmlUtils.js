...
exports.parseAppMetadata = exports.parseOfficeMetadata = exports.getDirectChildren = exports.getElementsByTagName = exports.parseXmlString = void 0;
 ...
 */
const parseAppMetadata = (xmlContent) => {
    const xml = (0, exports.parseXmlString)(xmlContent);
    const metadata = {};
    const props = (0, exports.getElementsByTagName)(xml, "Properties")[0];
    if (!props)
        return metadata;
    const pages = (0, exports.getElementsByTagName)(props, "Pages")[0];
    if (pages && pages.textContent)
        metadata.pages = parseInt(pages.textContent) || undefined;
    const words = (0, exports.getElementsByTagName)(props, "Words")[0];
    if (words && words.textContent)
        metadata.wordCount = parseInt(words.textContent) || undefined;
    const characters = (0, exports.getElementsByTagName)(props, "Characters")[0];
    if (characters && characters.textContent)
        metadata.characterCount = parseInt(characters.textContent) || undefined;
    const paragraphs = (0, exports.getElementsByTagName)(props, "Paragraphs")[0];
    if (paragraphs && paragraphs.textContent)
        metadata.paragraphCount = parseInt(paragraphs.textContent) || undefined;
    const slides = (0, exports.getElementsByTagName)(props, "Slides")[0];
    if (slides && slides.textContent)
        metadata.slideCount = parseInt(slides.textContent) || undefined;
    const application = (0, exports.getElementsByTagName)(props, "Application")[0];
    if (application && application.textContent)
        metadata.application = application.textContent;
    const appVersion = (0, exports.getElementsByTagName)(props, "AppVersion")[0];
    if (appVersion && appVersion.textContent)
        metadata.appVersion = appVersion.textContent;
    return metadata;
};
exports.parseAppMetadata = parseAppMetadata;
