...
(function (OfficeErrorType) {
    ...
    OfficeErrorType["FILE_ENCRYPTED"] = "FILE_ENCRYPTED";
...
const ERROR_MESSAGES = {
    [OfficeErrorType.EXTENSION_UNSUPPORTED]: (ext) => `Sorry, OfficeParser currently supports docx, pptx, xlsx, doc, xls, ppt, odt, odp, ods, pdf, rtf files only. Create a ticket in Issues on github to add support for ${ext} files. Stay tuned for further updates.`,
    ...
    [OfficeErrorType.FILE_ENCRYPTED]: (filepath) => `File ${filepath || 'provided'} appears to be encrypted or password-protected. OfficeParser cannot parse encrypted files. Please remove the password protection and try again.`
};
/**
